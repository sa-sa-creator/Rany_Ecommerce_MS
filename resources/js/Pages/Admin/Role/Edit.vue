<template>
    <AdminLayout title="Role | Edit">
        ...
        <section
            class="bg-white dark:bg-gray-800 lg:rounded-2xl lg:mt-16 lg:mx-36"
        >
            <div class="h-full max-w-2xl px-4 py-4 mx-auto lg:py-16">
                <h2
                    class="mb-4 text-xl font-bold text-gray-900 dark:text-white"
                >
                    <Text :message="$t('updateRole')" class="mr-1"></Text>
                </h2>
                <form
                    @submit.prevent="
                        ($event) => form.put(route('role.update', role.id))
                    "
                >
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        >
                            <Text :message="$t('Update')" class="mr-1"></Text>
                        </button>
                    </div>
                </form>
            </div>
