...
<template>
    ...
    <aside
        id="logo-sidebar"
        class="fixed left-0 z-40 w-64 h-screen pt-2 -translate-x-full bg-white border-r border-gray-200 top-16 sm:transition-transform lg:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
    >
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    ...
                    >
                        ...
                        <SidebarText :message="$t('Dashboard')" />
                    </SidebarLink>
                </li>
                    ...
                    <ul id="dropdown-user" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <SidebarLink
                                ...
                                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                                <SidebarText :message="$t('Permission')" />
                            </SidebarLink>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <button
                        type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        aria-controls="user-dropdown3"
                        data-collapse-toggle="user-dropdown3"
                    >
                        <svg
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                            aria-hidden="true"
                    ...
                    <ul id="user-dropdown3" class="hidden py-2 space-y-2">
                        <li>
                            <SidebarLink
                                :href="route('role.index')"
                                :active="route().current('role.index')"
                ...
                <li>
                    <button
                        type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        aria-controls="user-dropdown2"
                        data-collapse-toggle="user-dropdown2"
                    >
                        <svg
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                            aria-hidden="true"
                    ...
                    <ul id="user-dropdown2" class="hidden py-2 space-y-2">
                        <li>
                            <SidebarLink
                                :href="route('role.index')"
                                :active="route().current('role.index')"
